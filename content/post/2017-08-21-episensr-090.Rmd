...
p1 <- ggplot(dat, aes(x = Se, y = Sp, z = OR_c)) +
    ...
    annotate("text", x = 1, y = 1, label = "4.32", size = 2) +
    ...
    theme(plot.title = element_text(face = "bold", size = 8),
          ...
          axis.text.y = element_text(colour="grey42", size = 5),
          axis.text.x = element_text(colour="grey42", size = 5),
          legend.position = "none") +
    xlab("Sensitivity") +
    ylab("Specificity") +
    ggtitle("Estimate of Corrected OR")
direct.label(p1, list("far.from.others.borders", "calc.boxes", "enlarge.box", 
                           hjust=1, vjust=-.5, box.color = NA, cex = .5,
...
p3 <- ggplot(dat, aes(x = Se, y = Sp, z = ORc_lci)) +
    ...
    annotate("text", x = 1, y = 1, label = "2.96", size = 2) +
